...
def showStartScreen():
    titleFont = pygame.font.Font('geektastic.ttf', 100)
    titleSurf1 = titleFont.render('SNAKEZ', True, WHITE, DARKBLUE)
    titleSurf2 = titleFont.render('SNAKEZ', True, BLUE)
...
def showGameOverScreen():
    gameOverFont = pygame.font.Font('geektastic.ttf', 150)
